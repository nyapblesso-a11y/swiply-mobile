  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.primaryButton} onPress={handleLogin} disabled={loading}>
        {loading ? <ActivityIndicator color="#FAF9F6" /> : <Text style={styles.primaryButtonText}>Log In</Text>}
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 30, fontWeight: '600', color: '#1F2A37', textAlign: 'center' },
  subtitle: { fontSize: 14, color: '#5C6570', textAlign: 'center', marginBottom: 32 },
  input: {
